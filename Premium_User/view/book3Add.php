        ...
        <form method="POST" action="../controller/addBookCheck.php" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <input type="number" name="bookID" value="21">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="bookname" value="Haunted Forest">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="category" id="category">
                            ...
                            <option value="story_book" selected>Story Book</option>
                ...
                <tr>
                    ...
                    <td><input type="text" name="author" value="Albert Lee"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="dd" style="width:40px;" value="23"> / <input type="number" name="mm" style="width:40px;" value="4">	/ <input type="number" name="yyyy" style="width:60px;" value="2021"> <i>(dd/mm/yyyy)</i></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="price" value="120"></td>
                </tr>
