...
<div style="display: grid; grid-template-columns: 1fr 1fr; padding-top: 0.5em;">
    ...
    <div id="main_content" style="background-color: white; width: 1210px; font-family: arial; align-items: center; text-align: center;">
       ...
       <a href="addBooks.php" style="text-decoration: none;">
        <span style="font-size: 25px"><b>3.Add Books  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</b></span>
        <br><br>

  <!-- Add Course -->
       <a href="courselist.php" style="text-decoration: none;">
        <span style="font-size: 25px"><b><b><b>4. Course   &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  </b></b></b></span>
        <br><br>
		
		 <!-- Payment -->
       <a href="payment.php" style="text-decoration: none;">
        <span style="font-size: 25px"><b><b><b>5.Payment &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; </b></b></b></span>
        <br><br>
		
        <!-- Enrolled Student List -->
       <a href="Studentlist.php" style="text-decoration: none;">
        <span style="font-size: 25px"><b>6.Enrolled Student list   &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; </b></span>
        <br><br>
