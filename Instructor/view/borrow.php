...
<div style="display: grid; grid-template-columns: 1fr 1fr; padding-top: 0.5em;">
    ...
    <div id="main_content" style="background-color: white; width: 1210px; font-family: arial; align-items: center; text-align: center;">
        ...
        <!-- picture -->
        <img src="../../Admin/assets/images/<?php echo $book['filename'];?>" alt="<?=$book['bookname']?>" height="300px" width="250px">
        <br><br>
        ...
        <!-- Borrow Book -->
        <a href="../controller/borrowlist.php"><b style="font-size: 20px;">borrow the Book</b></a> 
    </div>
</div>
