        ...
        <form method="POST" action="../controller/addBookCheck.php" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <input type="number" name="bookID" value="10">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="bookname" value="Harry Potter">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="author" value="J. K. Rowling "></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="dd" style="width:40px;" value="2"> / <input type="number" name="mm" style="width:40px;" value="12">	/ <input type="number" name="yyyy" style="width:60px;" value="2011"> <i>(dd/mm/yyyy)</i></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="price" value="30"></td>
                </tr>
