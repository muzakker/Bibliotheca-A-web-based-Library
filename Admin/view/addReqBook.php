...
<div style="display: grid; grid-template-columns: 1fr 1fr; padding-top: 0.5em;">
    ...
    <div id="main_content" style="background-color: white; width: 1210px; font-family: arial; align-items: center; text-align: center;">
        ...
        <?php
            ...
            $id = $_GET['requestId'];
            $row = getRequestBookByID($id);
        ?>
        <form id="addBookForm" method="POST" action="../controller/addBookCheck.php" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    <td>
                        Book ID
                ...
                <tr>
                    ...
                    <td><input type="text" name="author" value="<?=$row['authorName']?>"></td>
                </tr>
