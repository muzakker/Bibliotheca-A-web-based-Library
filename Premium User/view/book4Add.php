        ...
        <form method="POST" action="../controller/addBookCheck.php" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <input type="number" name="bookID" value="22">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="bookname" value="Elon Musk">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="category" id="category">
                            ...
                            <option value="life_story_book" selected>Life Story Book</option>
                ...
                <tr>
                    ...
                    <td><input type="text" name="author" value="Elon Musk"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="dd" style="width:40px;" value="14"> / <input type="number" name="mm" style="width:40px;" value="8">	/ <input type="number" name="yyyy" style="width:60px;" value="2022"> <i>(dd/mm/yyyy)</i></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="price" value="150"></td>
                </tr>
