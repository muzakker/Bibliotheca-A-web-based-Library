...
<body>
    ...
    <!-- sign up form -->
    <div style="background-image: url('../assets/images/library.jpg'); background-size: cover; background-position: center; height: 980px; width: 100%; display:block; text-align: center; align-items:center;">
        <hr>
