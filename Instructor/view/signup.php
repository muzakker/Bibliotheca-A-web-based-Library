...
<body>
    ...
    <!-- sign up form -->
    <div style="background-image: url('library.jpg'); background-size: cover; background-position: center; height: 980px; width: 100%; display:block; text-align: center; align-items:center;">
        <hr>
    ...
    <script type="text/javascript" src="controller/signupCheck.js"></script>
</body>
