        ...
        <form method="POST" action="../controller/addBookCheck.php" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <input type="number" name="bookID" value="1">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="bookname" value="Rain Birds">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="author" value="clarissa"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="dd" style="width:40px;" value="1"> / <input type="number" name="mm" style="width:40px;" value="1">	/ <input type="number" name="yyyy" style="width:60px;" value="2001"> <i>(dd/mm/yyyy)</i></td>
                </tr>
