...
?>
        ...
        <div id="nav_bar" style="background-color:#caefff; height: 100px; width: 100%; font-family: arial; display: flex; align-items: center; text-align: center;">
            ...
            <span style="margin-left:auto; margin-right:0;">
                ...
                <!-- sign in -->
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <a href="Admin/view/signin.php" style="text-decoration: none;">
                    <i title="sign in" class="fas fa-sign-in-alt" style="font-size:35px; color:black;"></i>
                </a>

                <!-- sign up -->
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <a href="Admin/view/signup.php" style="text-decoration: none;">
        ...
        <!-- image -->
        <div id="image">
            <img src="Admin/assets/images/library.jpg" alt="Library" height="700px" width="100%">
        </div>
        ...
        <div id="about_us" style="background-color: #caefff; height: 300px; width: 100%; font-family: arial; text-align: center;">
            ...
            <br><br><br>
            <button type="button" onclick="loadDoc()" style="border: 1px solid #cecfd5; padding: 10px 15px; color: blue;">Learn About the Developer</button>
            <script>
                function loadDoc() {
                const xhttp = new XMLHttpRequest();
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("about_us").innerHTML = this.responseText;
                    }
                };

                xhttp.open("GET", "Admin/view/dev-info.html", true);
                xhttp.send();
...
<?php include('Admin/view/footer.html')?>